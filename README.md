...
Примеры:
Змейка 1 с длиной в 7 единиц находится в состоянии ярости, змейка 2 с длиной в 11 единиц нет. Змейка 1 производит укус в клетку, следующую непосредственно за головой змейки 2. Этим самым активируется активируется логика лобового столкновения. После этого змейка 2 погибает, так как она в состоянии покоя, а змейка 1 в состоянии ярости. Змейке 1 начисляются очки за 11 единиц убитой змейки 2.
Змейка 1 с длиной в 7 единиц находится в состоянии покоя, змейка 2 с длиной в 11 единиц тоже в состоянии покоя. Змейка 1 производит укус в клетку, следующую непосредственно за головой змейки 2. Этим самым активируется активируется логика лобового столкновения. После этого змейка 1 погибает, так как они обе в состоянии покоя и её итоговая длина должна быть равна 7-11=-4, что меньше допустимых минимальных двух единиц длины. Змейка 2 выживает, её итоговая длина 11-7=4 и она получает очки за 7 единиц убитой змейки 1.
Змейка 1 с длиной в 7 единиц находится в состоянии ярости, змейка 2 с длиной в 11 единиц тоже в состоянии ярости. Змейка 1 производит укус в клетку, следующую непосредственно за головой змейки 2. Этим самым активируется активируется логика лобового столкновения. После этого змейка 1 погибает, так как они обе в состоянии ярости и её итоговая длина должна быть равна 7-11=-4, что меньше допустимых минимальных двух единиц длины. Змейка 2 выживает, её итоговая длина 11-7=4 и она получает очки за 7 единиц убитой змейки 1.
...
Змейка 1 с длиной в 7 единиц находится в состоянии покоя, змейка 2 с длиной в 11 единиц тоже в состоянии покоя. Змейка 1 производит укус в третью от головы змейки 2 клетку. Этим самым активируется активируется логика укуса в тело. После этого змейка 2 не погибает, её длина остаётся равной 11 единицам. Змейка 1 погибает. Змейке 2 начисляются очки за 7 единиц тела убитой змейки 1.
